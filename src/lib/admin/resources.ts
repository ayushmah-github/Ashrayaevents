...
export const RESOURCES: Record<string, Resource> = {
  ...
  site_settings: {
    ...
    fields: [
      ...
      { name: "collage_images", label: "Home collage photos", type: "imagelist", help: "Upload ONE ready-made collage image to show it full-width, or 8 photos to build the grid." },
