...
export const RESOURCES: Record<string, Resource> = {
  ...
  site_settings: {
    ...
    fields: [
      ...
      { name: "collage_images", label: "Home collage photos", type: "imagelist" },
      ...
      { name: "youtube_ids", label: "Testimonial YouTube video IDs", type: "list", help: "Just the ID after v= in a YouTube URL." },
      { name: "instagram_embed", label: "Instagram embed URL (optional)", type: "text" },
    ],
  },
};
