...
export const RESOURCES: Record<string, Resource> = {
  ...
  site_settings: {
    ...
    fields: [
      ...
      { name: "collage_images", label: "Home collage photos (grid — upload each tile)", type: "imagelist", help: "Add up to 8 photos, one per grid tile, in order. You can add them one at a time — empty slots show a placeholder until filled." },
